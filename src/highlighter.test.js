...
describe('Custom Padding', () => {
  ...
  it('Custom padding - 4 value', () => {
    ...
    expect(wrapper.html()).toBe('<p><span style=\"padding:1px 2px 3px 4px; background-color:#009688; color:#fff;\">Hello</span> World</p>')
  })
